...
type ChristmasServiceTimesFormData = {
    congregation: string;
    firstName: string;
    lastName: string;
    email: string;
        ...
        <form onSubmit={submit} className="space-y-8">
            <div>
                <h1 className="text-2xl font-semibold text-slate-900">
                    Christmas Holidays Service Times
                </h1>
                <p className="mt-2 text-sm text-slate-600">
                    Add all congregation service times across the Christmas
                    holiday period.
                </p>
                {recentlySuccessful ? (
                            ...
                            <div className="grid gap-3 md:grid-cols-2">
                                <div className="space-y-1">
                                    ...
                                    <Input
                                        ...
                                        placeholder="e.g. Christmas Day Morning"
                                    />

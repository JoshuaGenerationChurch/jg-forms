        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <SettingsLayout>
                <div className="space-y-6">
                    <Heading
                        title="Passkeys"
                        description="Manage your passkeys for quick and secure sign-in"
                    />
                    ...
                    <div className="space-y-6">
                            ...
                            {credentials.length === 0 ? (
                                <div className="rounded-lg border border-dashed p-8 text-center">
                                    ...
                                    <p className="mt-4 text-sm text-muted-foreground">
                                        ...
                                        Register one to enable quick and secure
                                        sign-in.
                                    </p>
                                </div>
                            ) : (
                        ...
                        <div className="rounded-lg border bg-muted/50 p-6">
                            ...
                            <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
                                ...
                                <li>
                                    • Each passkey is unique to this website and
                                    your device
                                </li>
                                <li>
                                    • You can register multiple passkeys for
                                    different devices
                                </li>
                                <li>
                                    • Keep your device secure with a strong PIN,
                                    password, or biometric
                                </li>
                                <li>
                                    • Remove passkeys for devices you no longer
                                    use or have lost
                                </li>
                            </ul>
                        </div>

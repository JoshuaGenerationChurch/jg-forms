...
export default function AdminFormsEntriesIndex({ forms }: Props) {
    const emailTemplatesBackTo = '/admin/forms/entries';
                ...
                <div className="rounded-md border border-slate-200 bg-white p-8 shadow-sm">
                    ...
                    <div className="mt-4">
                        <Button variant="outline" asChild>
                            <Link
                                href={`/admin/forms/email-templates?backTo=${encodeURIComponent(emailTemplatesBackTo)}`}
                            >
                            ...
                            >
                                <div className="flex flex-wrap items-start justify-between gap-3">
                                    ...
                                    <div className="flex flex-wrap items-center gap-2">
                                        <Button variant="outline" asChild>
                                            <Link
                                                href={`/admin/forms/email-templates/${form.slug}?backTo=${encodeURIComponent(emailTemplatesBackTo)}`}
                                            >
                                                <Mail className="size-4" />
                                                Email templates
                                            </Link>
